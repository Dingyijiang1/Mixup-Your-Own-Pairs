...
def main(arguments):
    ...
    parser.add_argument('--contrastive_method', default='none', choices=['simclr', 'supcon', 'myop_neg', 'myop_pos', 'myop', 'none', 'simcse'])
    ...
    parser.add_argument('--store_root', help='store root path', type=str, default='/root/autodl-tmp/checkpoint')
