...
class AgeDB(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train_cl': # two views for the training of contrastive learning
    ...
    def get_transform(self):
        if self.split in ['train_cl']: # for contrastive learning
            transform = transforms.Compose([
                transforms.RandomResizedCrop(self.img_size, scale=(0.2, 1.)),
